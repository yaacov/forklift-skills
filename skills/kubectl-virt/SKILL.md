...
> Full series table, sizing table, and preferences list: [reference.md](reference.md)
...
> Full disk source table, containerdisk images, and DataSource details: [reference.md](reference.md)
...
> Methods 2-5 with full examples: [reference.md](reference.md)
